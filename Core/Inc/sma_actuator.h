...
#define FAN_TEMP_DIFF_FULL   6.0f    // ΔT ≥ 5 ℃ → 팬 풀
#define FAN_TEMP_DIFF_OFF    2.0f    // ΔT ≤ 2 ℃ → 팬 OFF
#define FAN_P_GAIN          20.0f    // ΔT * 20 → duty[%] (튜닝용)
 ...
 * @note ControlTask에서 i2cMutex 획득 후 호출
 *       SMA_Update()와 분리하여 mutex 독립 관리
 */
